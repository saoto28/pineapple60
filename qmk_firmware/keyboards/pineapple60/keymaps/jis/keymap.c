...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /* Base
   ...
   */
    [_BASE] = LAYOUT(
      ...
      KC_LCTL,  KC_Z, KC_X,      KC_C,     KC_V,            KC_B,     KC_N,   KC_M,           KC_COMM, KC_DOT,  KC_SLSH,  KC_RO,   KC_RSFT,
      KC_CAPS,  KC_LGUI, A(KC_LEFT), KC_LALT, LT(_NUM,KC_MHEN),KC_SPC,   KC_SPC,LT(_FNC,KC_HENK),KC_RALT, KC_RCTL, KC_PGUP,    KC_UP,   KC_PGDN,
 ...
 /* Num
   ...
   */
    [_NUM] = LAYOUT(
      _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______, 
      _______,  S(KC_1),  S(KC_2),  S(KC_3),  S(KC_4),  S(KC_5),   S(KC_6),  S(KC_7),  S(KC_8),  S(KC_9),  KC_LBRC,  S(KC_JYEN),_______,
      _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     S(KC_LBRC),_______,
      _______,  KC_PPLS,  KC_PMNS,  KC_PAST,  KC_PSLS,  S(KC_MINS),KC_RBRC,  KC_NUHS,  S(KC_RBRC),S(KC_NUHS),KC_EQL, S(KC_EQL),_______,
      _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
                                                             _______,                                      _______,  _______,  _______
    )
};
